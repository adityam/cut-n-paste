...
\def\cut!n!paste!initializepagecount
 {\doifsomethingelse{\cut!n!paste!parameter\c!stop}
  ...
  \def\cut!n!paste!increment{\plusone}%
  \doif{\cut!n!paste!parameter\c!alternative}\v!reverse  
   {\swapmacros\cut!n!paste!startpage\cut!n!paste!stoppage
    \def\cut!n!paste!increment{\minusone}}}

%D place pages

\def\cut!n!paste!placepages
  {\cut!n!paste!initializepagecount
   \dostepwiserecurse\cut!n!paste!startpage\cut!n!paste!stoppage\cut!n!paste!increment
...
\def\cut!n!paste!placetestpages
  {\cut!n!paste!initializepagecount
   \dostepwiserecurse\cut!n!paste!startpage\cut!n!paste!stoppage\plusone %not \cut!n!paste!increment
    {\edef\cut!n!paste!currentpage{\recurselevel}%
     \cut!n!paste!initializeparameters
...
\definecutNpaste[IEEEconf]
                [\c!n=2,
                 \c!width=44pc,    
                 \c!height=\the\dimexpr 9.25in + 18pt\relax,
                 \c!hoffset=\the\dimexpr 0.68in - 0.5pc\relax,
                 \c!voffset=\the\dimexpr 0.5in + 12pt\relax]

\setupIEEEconf[1][\c!span=yes,\c!span\c!height=2in]

\definecutNpaste[IEEEjournal]
                [\c!n=2,
                 \c!width=44pc,    
                 \c!height=\the\dimexpr 58pc + 18pt\relax,
                 \c!hoffset=\the\dimexpr 0.68in - 1.5pc\relax,
                 \c!voffset=\the\dimexpr 1in - 49pt + 12pt + 0.25in \relax]

\setupIEEEconf[1][\c!span=yes,\c!span\c!height=2in]

\startmode[IEEEconf]
  \starttext
    \processIEEEconf[name=\jobname]
  \stoptext
\stopmode
