...
%D Parameters
\def\cut!n!paste!pageparamter#1% pagenum parameter
...
\def\cut!n!paste!span!voffset
  {\ifconditional\cut!n!paste!topspan
     \cut!n!paste!pageparamter\c!voffset
   \else
     \the\dimexpr\cut!n!paste!pageparamter\c!voffset
     +\cut!n!paste!pageparamter\c!height
     -\cut!n!paste!pageparamter{\c!span\c!height}\relax
    \fi}

\def\cut!n!paste!height
  {\ifconditional\cut!n!paste!span
     \the\dimexpr\cut!n!paste!pageparamter\c!height
     -\cut!n!paste!pageparamter{\c!span\c!height}\relax
   \else
     \cut!n!paste!pageparamter\c!height
  \fi}
...
\def\cut!n!paste!hoffset
  {\the\dimexpr\cut!n!paste!pageparamter\c!hoffset
...
\def\cut!n!paste!pagewidth
  {\the\dimexpr\cut!n!paste!pageparamter\c!width
   /\cut!n!paste!pageparamter\c!n\relax}
...
\def\cut!n!paste!insertpage%
  {\ifconditional\cut!n!paste!span
    \startTEXpage
      \clip
        [   \c!width=\cut!n!paste!pageparamter\c!width,
           \c!height=\cut!n!paste!pageparamter{\c!span\c!height},
          \c!hoffset=\cut!n!paste!pageparamter\c!hoffset,
          \c!voffset=\cut!n!paste!span!voffset]
        {\externalfigure[cnp:name][\c!page=\cut!n!paste!currentpage]}
    \stopTEXpage
  \fi
  \dorecurse{\cut!n!paste!pageparamter\c!n}
  {\startTEXpage
      \clip
      [   \c!width=\cut!n!paste!pagewidth,
        ...
        {\rotate
          [\c!rotation=\cut!n!paste!pageparamter\c!rotation]
           {\externalfigure[cnp:name][\c!page=\cut!n!paste!currentpage]}}
     \stopTEXpage}}
...
\def\cut!n!paste!inserttestpage%
   {\setupMPvariables
      ...
      [              \c!width=\cut!n!paste!pageparamter\c!width,
                   ...
                   \c!hoffset=\cut!n!paste!pageparamter\c!hoffset,
                   \c!voffset=\cut!n!paste!voffset,
                         \c!n=\cut!n!paste!pageparamter\c!n,
              \c!grid\c!color=\cut!n!paste!pageparamter{\c!grid\c!color},
                \c!framecolor=\cut!n!paste!pageparamter\c!framecolor,
             \c!rulethickness=\cut!n!paste!pageparamter\c!rulethickness,
             \c!span\c!height=\cut!n!paste!pageparamter{\c!span\c!height},
            \c!span\c!voffset=\cut!n!paste!span!voffset,
         \c!span\c!framecolor=\cut!n!paste!pageparamter{\c!span\c!framecolor},
      \c!span\c!rulethickness=\cut!n!paste!pageparamter{\c!span\c!rulethickness}]
   %
   \startTEXpage[\c!background={\v!foreground,cnp:grid}]
    \rotate[\c!rotation=\cut!n!paste!pageparamter\c!rotation]
      {\externalfigure[cnp:name][\c!page=\cut!n!paste!currentpage]}
   \stopTEXpage}
...
\def\cut!n!paste!initializeparameters
  {\doifelse{\cut!n!paste!pageparamter\c!span}\v!yes
    {\settrue\cut!n!paste!span
     \doifelse{\cut!n!paste!pageparamter{\c!span\c!location}}\v!top
...
\def\placecutNpaste
  {\dosingleargument\doplacecutNpaste}

\def\doplacecutNpaste[#1]%
  {\setupcutNpaste[#1]%
   \useexternalfigure[cnp:name][\@@@@cnpname]%
...
\setupcutNpaste
  [\c!option=,
   ...
   \c!rulethickness=1bp,
   \c!span=\v!no,
   \c!span\c!height=\cut!n!paste!pageparamter\c!height,
